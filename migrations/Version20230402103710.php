 ...
 */
final class Version20230402103710 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contingut ADD entradaid INT DEFAULT NULL, DROP entradaid_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contingut ADD entradaid_id INT NOT NULL, DROP entradaid');
